...
### Backend application conventions

Backend app structure and layering conventions are documented in [`docs/conventions/backend.md`](docs/conventions/backend.md). Follow that guide when adding or restructuring a backend service, including feature modules, routes, handlers, schemas, services, shared libraries, repositories, errors, security boundaries, and validation workflows.
