/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 5459a3c833ebaf1309af795db7284eaf)
// Runtime types generated with workerd@1.20260730.1 2026-08-02 nodejs_compat_v2
interface __BaseEnv_CloudflareBindings {
	FREE_POS_DATABASE_URL: string;
	FREE_POS_JWT_SECRET: string;
	FREE_POS_FRONTEND_ORIGIN: string;
	FREE_POS_COOKIE_DOMAIN: string;
	FREE_POS_EMAIL_API_KEY: string;
	FREE_POS_EMAIL_FROM: string;
}
